    ...
    <main id="main" className={styles.main}>
      <section className={styles.heroShell} id="top" aria-labelledby="forma-title">
        ...
        <div className={styles.heroInner}>
          <div className={styles.heroCopy}>
            ...
            <h1 id="forma-title">לגלות,<br />לדייק.</h1>
          ...
          <figure className={styles.heroVisual}>
            <div className={styles.heroPhoto}><Image src="/demos/forma-hair-hero.webp" alt="דיוקן להמחשה של אישה עם שיער כהה וגלי" fill sizes="(max-width: 720px) 82vw, 42vw" preload /></div>
      ...
      <section data-site-reveal="" className={styles.bento} id="services" aria-labelledby="services-title">
        <article className={styles.servicesCard}>
          ...
          <div className={styles.servicesBottom}>
            <div className={styles.salonCrop}><Image src="/demos/forma-editorial-hero-v2.webp" alt="חלל סטודיו שיער מואר בגוונים טבעיים" fill sizes="(max-width: 720px) 90vw, 34vw" /></div>
            <p>כל שירות מתחיל בשיחה קצרה על השיער, הזמן שלך והתחושה שאת רוצה לקחת איתך.</p>
            <div className={styles.greenMetric}><strong>03</strong><span>תחומי טיפול.<br />גישה אחת אישית.</span></div>
          </div>
        </article>

        <article className={styles.insightCard} id="approach" aria-labelledby="approach-title">
          <p className={styles.eyebrow}>02 / הגישה</p>
          <h2 id="approach-title"><span>הסטודיו נולד מתוך</span><br />הקשבה, דיוק<br /><span>ותנועה טבעית.</span></h2>
          <div className={styles.insightBottom}><div><strong>1:1</strong><p>גישה אישית למרקם,<br />לשגרה ולך.</p></div><div className={styles.arcs} aria-hidden="true"><i /><i /><i /><i /></div></div>
          <ul className={styles.floatingNotes} aria-label="עקרונות העבודה"><li>קודם מקשיבים</li><li>אחר כך מעצבים</li><li>מסבירים גם לבית</li></ul>
        </article>
      </section>
      ...
      <section data-site-reveal="" className={styles.questions} id="questions" aria-labelledby="questions-title">
        ...
        <div className={styles.questionList}>
          ...
          <details><summary>כדאי להביא תמונות השראה?</summary><p>בהחלט. הן עוזרות להבין מה אהבת, בלי להתחייב להעתקה של מראה שלא בהכרח מתאים למרקם שלך.</p></details>
          <details><summary>איך שומרים על המראה בבית?</summary><p>בסיום מסבירים איך לייבש, לעצב ולשמור על המראה בעזרת שגרה פשוטה.</p></details>
        </div>
      </section>
