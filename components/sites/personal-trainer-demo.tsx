  ...
  return <div className={styles.site} dir="rtl" lang="he" data-demo="move-trainer-v1">
    ...
    <div className={styles.frame}>
      ...
      <main id="main">
        ...
        <section className={styles.about} id="about" aria-labelledby="about-title"><p className={styles.eyebrow}>✦ ABOUT MOVE</p><h2 id="about-title">אימון שעוזר לבנות <span>כוח, לשפר תנועה,</span><br />ולהרגיש טוב יותר ביום־יום.</h2><div className={styles.aboutGrid}><figure className={styles.aboutWide}><Image src="/demos/move-coastal-runner-v3.webp" alt="אישה רצה בשביל סמוך לים" fill sizes="(max-width: 720px) 100vw, 34vw" /></figure><div className={styles.aboutStat}><strong>03</strong><span>עקרונות שמובילים<br />את כל מסלולי האימון</span><h3>מתאמנים חכם.<br />מתקדמים יציב.</h3><p>מכירים את נקודת הפתיחה, בונים בסיס ומוסיפים עומס רק כשהגוף מוכן.</p><a href="#paths">איך זה עובד <span aria-hidden="true">↙</span></a></div><figure className={styles.aboutPortrait}><Image src="/demos/move-trainer-hero.webp" alt="מאמן כושר בחדר אימון" fill sizes="(max-width: 720px) 100vw, 25vw" /></figure></div></section>
        ...
        <section className={styles.endcap} aria-labelledby="endcap-title"><span className={styles.eyebrow}>THE NEXT MOVE IS YOURS</span><h2 id="endcap-title">גם לעסק שלכם<br />מגיע אתר חזק.</h2><div><p>זהו אתר הדגמה לעסק דמיוני. בנו אתר תדמיתי מקורי עם Slate Sites.</p><Link href="/auth?next=/dashboard/new">בנו אתר לעסק שלכם <span aria-hidden="true">←</span></Link></div></section>
      </main>
