  ...
  return <div className={`${styles.site} ${styles.trainer}`} dir="rtl" data-demo="move-trainer-v1">
    ...
    <main id="main">
      <section className={styles.trainerHero} id="top" aria-labelledby="trainer-title">
        ...
        <figure className={styles.trainerPortrait}><Image src="/demos/move-action-hero-v2.webp" alt="מאמנת כושר מתאמנת עם חבלי כוח בחדר אימון כהה" fill sizes="100vw" preload /><figcaption><span>הצעד הראשון?</span><strong>פשוט להתחיל.</strong></figcaption></figure>
      </section>
